...
class Main_Scene extends Simulation {
    constructor() {
        ...
        this.textures = {
            ...
            // TODO: TEXTURES
            space: new Texture("assets/textures/gradient4.png", "LINEAR_MIPMAP_LINEAR"),
    ...
    display(context, program_state) {
        ...
        if(this.color_lerp < 1) {
            this.color_lerp += (0.00005 * dt);
        }
        else {
            this.color_lerp = 1;
        }
        ...
        this.shapes["space"].draw(context, program_state, Mat4.scale(1000000, 1000000, 1000000), this.space_material);
